...
def run_tests(config_path):
    ...
    test_suite = [
        ...
        ("Xiaomi Alioth Hardware", "Dual KTZ8866 Conflict Check", "CONFIG_BACKLIGHT_DUALKTZ8866", "n", "Must be disabled for single-panel alioth to avoid symbol collision", "FATAL"),
        ...
        ("Kernel 4.19 Backports", "F2FS Compression Backport", "CONFIG_F2FS_FS_COMPRESSION", "y", "Userdata block compression", "FATAL"),
